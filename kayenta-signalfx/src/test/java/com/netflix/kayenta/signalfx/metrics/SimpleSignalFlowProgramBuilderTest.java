...
public class SimpleSignalFlowProgramBuilderTest {
  ...
  public static Object[][] locationScopeProvider() {
    return new Object[][] {
      ...
      },
      {
        ...
        SignalFxScopeConfiguration.builder().defaultLocationKey("region").build()
      }
    };
  }
  ...
  @Test
  public void
      test_that_the_program_builder_builds_the_expected_program_with_extra_scope_qp_pairs() {
  ...
  @Test
  public void
      test_that_when_there_are_extra_scope_query_pairs_that_the_program_builds_as_expected() {
    String metricName = "request.count";
    String aggregationMethod = "mean";
  ...
  public void test_that_if_a_default_scope_key_was_defined_it_is_used_if_not_overwritten() {
    ...
    SignalFxScopeConfiguration scopeConfiguration =
        SignalFxScopeConfiguration.builder().defaultScopeKey("server_group").build();
