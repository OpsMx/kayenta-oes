...
public class GraphiteFetchController {
  ...
  @Autowired
  public GraphiteFetchController(
  ...
  public Map queryMetrics(
    ...
    start =
        determineDefaultProperty(
            start, "start", graphiteConfigurationTestControllerDefaultProperties);
    end =
        determineDefaultProperty(end, "end", graphiteConfigurationTestControllerDefaultProperties);
    scope =
        determineDefaultProperty(
            scope, "scope", graphiteConfigurationTestControllerDefaultProperties);
    ...
    CanaryScope canaryScope =
        new CanaryScope(
            scope, location, Instant.parse(start), Instant.parse(end), null, Collections.EMPTY_MAP);
